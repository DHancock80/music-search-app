...
if search_query:
    ...
    if format_clean != 'All':
        ...
        results = st.session_state['filtered_results'][st.session_state['filtered_results']['Format'].fillna('').str.lower().str.contains(pattern, na=False)]['Format'].fillna('').str.lower().str.contains(pattern, na=False)]['Format'].fillna('').str.lower().str.contains(pattern, na=False)][st.session_state['filtered_results']['Format'].fillna('').str.lower().str.contains(pattern, na=False)].fillna('').str.lower().str.contains(pattern, na=False)]
