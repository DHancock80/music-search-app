        ...
        for release_id, group in grouped:
            ...
            with st.container():
                ...
                with cols[0]:
                    ...
                    if st.markdown(f'<a href="#" style="display:inline-block;margin-top:10px;" onclick="window.dispatchEvent(new CustomEvent(\'expandCoverArt\', {{ detail: {release_id} }})); return false;">Edit Cover Art</a>', unsafe_allow_html=True):
                        pass
