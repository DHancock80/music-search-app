...
DISCOGS_API_TOKEN = 'YOUR_DISCOGS_TOKEN_HERE'  # 🔑 Paste your Discogs token here

# GitHub settings
GITHUB_TOKEN = 'YOUR_GITHUB_TOKEN_HERE'  # 🔑 Paste your GitHub personal access token here
